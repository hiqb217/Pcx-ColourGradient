...
Varyings Vertex(Attributes input)
{
    ...
    half3 col = half3(_PointColor.r, _PointColor.g, _PointColor.b);
#endif
...
void Geometry(point Varyings input[1], inout TriangleStream<Varyings> outStream)
{
    ...
    UNITY_LOOP for (uint i = 1; i < slices; i++)
    {
        ...
        o.color = o.color * (1-_Darkness) + sn * _Darkness;
        outStream.Append(o);

        // Left side vertex
        o.position.x = origin.x - extent.x * sn;
        o.color = o.color * (1-_Darkness) + cs * _Darkness;
        outStream.Append(o);
    }
